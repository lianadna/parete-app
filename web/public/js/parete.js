...
const NAV_ITEMS = [
  { section: 'Menu Utama' },
  { id: 'dashboard',  label: 'Dashboard',    icon: 'ph-house',          href: 'dashboard.html' },
  { id: 'pengaduan',  label: 'Pengaduan',    icon: 'ph-clipboard-text', href: 'pengaduan.html', badge: 3 },
  { id: 'informasi',  label: 'Informasi',    icon: 'ph-megaphone-simple',href: 'informasi.html' },
  { id: 'dokumen',    label: 'Dokumen',      icon: 'ph-files',          href: 'dokumen.html' },
  { section: 'Pengelolaan' },
  { id: 'warga',      label: 'Data Warga',   icon: 'ph-users-three',    href: 'warga.html' },
  { id: 'admin',      label: 'Manajemen Admin', icon: 'ph-shield-check', href: 'admin.html' },
  { section: 'Sistem' },
  { id: 'pengaturan', label: 'Pengaturan',   icon: 'ph-gear',           href: 'pengaturan.html' },
];

/* ── Render Sidebar ─────────────────────────────── */
function renderSidebar(activeId) {
  const currentPage = activeId ||
    ...
    <nav class="sidebar-nav">${navHTML}</nav>
      <div class="sidebar-footer">
        <div class="sidebar-user">
          ...
          <a href="login.html" title="Keluar" style="color:var(--gray-400);font-size:18px;margin-left:auto;">
